  ...
  return (
    <Dialog.Root open onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-x-0 bottom-0 z-[90] max-h-[92dvh] overflow-y-auto rounded-t-[24px] border border-slate-200 bg-white opacity-0 shadow-[0_24px_80px_rgba(15,23,42,0.24)] outline-none transition data-[state=open]:opacity-100 sm:inset-auto sm:left-1/2 sm:top-1/2 sm:w-[min(520px,calc(100vw-32px))] sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-[22px]">
          ...
          <div className="mt-5 grid grid-cols-2 gap-2 border-t border-slate-100 px-5 py-4 pb-[calc(1rem+env(safe-area-inset-bottom))] sm:px-6 sm:pb-5">
            ...
            <AlertDialog.Root>
              ...
              <AlertDialog.Portal>
                <AlertDialog.Overlay className="fixed inset-0 z-[100] bg-slate-950/50 backdrop-blur-[2px]" />
                <AlertDialog.Content className="fixed left-1/2 top-1/2 z-[110] w-[min(420px,calc(100vw-32px))] -translate-x-1/2 -translate-y-1/2 rounded-[20px] border border-slate-200 bg-white p-5 shadow-[0_24px_80px_rgba(15,23,42,0.26)] outline-none sm:p-6">
                  <AlertDialog.Title className="text-[16px] font-semibold text-slate-950">
                    Delete this schedule?
                  </AlertDialog.Title>
                  <AlertDialog.Description className="mt-2 text-[12.5px] leading-5 text-slate-500">
